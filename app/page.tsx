  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 lg:px-8">
        <section className="grid gap-8 pt-6 lg:grid-cols-[1.03fr_0.97fr] lg:items-center">
          <Reveal className="grid gap-6">
            ...
            <p className="section-copy max-w-2xl">
              ...
              diversion, petroleum-offset potential, regional processing, and downstream paving-product
              integration.
            </p>
        ...
        <SectionShell
          description="The model is designed to link inbound waste capture with disciplined processing and downstream infrastructure relevance."
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="surface-card">
              <h3 className="text-2xl font-semibold text-[var(--rr-text)]">What the loop creates</h3>
              <ul className="mt-6 space-y-4">
                {[
                  ...
                  "A feedstock-oriented recovery model with downstream relevance",
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="grid gap-4">
              {[
                {
                  title: "Regulatory and procurement attention",
                  description:
                    "Careful, measurable diversion language matters more as sustainability scrutiny becomes more practical and less performative.",
                },
                {
                  title: "Infrastructure and paving relevance",
                  description:
                    "Recovered shingles become more strategic when connected to real downstream demand rather than isolated waste handling.",
                },
                {
